      ...
      <b-navbar-nav class="ml-auto" >
        ...
        <router-link class="nav-link" to="/home"> Home </router-link>
          ...
          <router-link class="nav-link" to="/contactus"> Contact us </router-link>
              ...
              <b-nav-item-dropdown v-if="localStorage.isLoggedIn && !$auth.loading"  text="User" right  class="nav-link" no-caret style="margin: 0 !important; padding: 0 !important;">
            ...
            <router-link  v-if="!localStorage.isLoggedIn && !$auth.loading" class="nav-link" to="" @click.native="login"> Login </router-link>
      </b-navbar-nav>
